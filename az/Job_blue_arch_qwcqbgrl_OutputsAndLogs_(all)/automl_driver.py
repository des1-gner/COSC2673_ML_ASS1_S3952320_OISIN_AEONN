...
subscription_id = "aa8b077f-0a98-4fef-8620-97716eb49e93" # PLACEHOLDER
resource_group = "ml" # PLACEHOLDER
experiment_name = "mlass1" # PLACEHOLDER
iteration = "40"  # PLACEHOLDER
run_id = "AutoML_12281443-f8b6-44ee-82b1-38498fc95d0b_40"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'mlass1','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':360,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':360,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'mlass1','path':'./sample_projects/mlass1','primary_metric':'normalized_root_mean_squared_error','region':'australiaeast','resource_group':'ml','subscription_id':'aa8b077f-0a98-4fef-8620-97716eb49e93','task_type':'regression','validation_size':0.2,'test_size':None,'vm_type':'Standard_DS3_v2','workspace_name':'mlproject','label_column_name':'TARGET_LifeExpectancy','enable_batch_run':True,'dataset_id':'b047a923-c328-4e86-aa06-1df07d749999'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','ensemble_iterations':15,'is_timeseries':False,'name':'mlass1','compute_target':'mlass1','subscription_id':'aa8b077f-0a98-4fef-8620-97716eb49e93','region':'australiaeast','grain_column_names':None}\",\"ensemble_run_id\":\"AutoML_12281443-f8b6-44ee-82b1-38498fc95d0b_40\",\"experiment_name\":\"mlass1\",\"workspace_name\":\"mlproject\",\"subscription_id\":\"aa8b077f-0a98-4fef-8620-97716eb49e93\",\"resource_group_name\":\"ml\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"b047a923-c328-4e86-aa06-1df07d749999\"},\"test_data\":{\"datasetId\":\"99762026-d477-4fcc-b21e-53aa762a929e\"}}" # PLACEHOLDER
